...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "bazcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override bazcoin.conf
...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using Bazcoin, please see <%s>."),
