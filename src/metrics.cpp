...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your bazcoin.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a Bazcoin node!") << std::endl;
    ...
    while (true) {
        ...
        if (isScreen) {
            ...
            std::cout << "[";
#ifdef WIN32
            std::cout << _("'bazcoin-cli.exe stop' to exit");
#else
